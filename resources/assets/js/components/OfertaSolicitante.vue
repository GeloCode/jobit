  ...
  <div id="ofertasolicitante">
    <header class="header container-fluid">
      <div class="header-img row">
        ...
        <div class="container">
          <div class="row offerts">
            <div class="blog-oferts col-lg-8">
              <div class="card" :key="oferta.id" v-for="oferta in ofertas">
                <div class="card-header">
                  <h4 class="mb-0">
                    <button class="btn btn-link" data-toggle="collapse" :data-target="'#collapse' + oferta.id" aria-expanded="false" :aria-controls="'#collapse' + oferta.id"
                      v-text="oferta.titulo">
                    </button>
                  </h4>
                </div>
